...
const AuthPage = () => {
    ...
    const loginForm = (feedbackText && feedbackType) ? <LoginFormContainer changeFormHandler={setFormType} feedbackText={feedbackText} feedbackResult={feedbackType}/> : <LoginFormContainer changeFormHandler={setFormType} />;
